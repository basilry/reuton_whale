...
- 사용자 홈의 Telegram 연결 CTA/QR은 현재 **WhaleScope 데모 봇** `@whalescope_demo_bot` ([https://t.me/whalescope_demo_bot](https://t.me/whalescope_demo_bot))으로 연결됩니다. 클라이언트 번들은 `NEXT_PUBLIC_TELEGRAM_BOT_USERNAME=whalescope_demo_bot`을 참조합니다.
